...
export declare function TextFab({ children, theme, onClick, accessibilityLabel, }: TextFabProps): JSX.Element;
...
export declare function IconFab({ icon, theme, onClick, accessibilityLabel, }: IconFabProps): JSX.Element;
export {};
