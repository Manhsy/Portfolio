...
var TRANSITION_OPEN_SPEED = tokens.tpDuration5;
var TRANSITION_CLOSE_SPEED = tokens.tpDuration4;
/**
...
function (_React$Component) {
  _rollupPluginBabelHelpers.inherits(ModalFooter, _React$Component);

  function ModalFooter(props) {
    var _this;

    _rollupPluginBabelHelpers.classCallCheck(this, ModalFooter);

    _this = _rollupPluginBabelHelpers.possibleConstructorReturn(this, _rollupPluginBabelHelpers.getPrototypeOf(ModalFooter).call(this, props));
    _this.state = {
      isClient: false
    };
    return _this;
  ...
  _rollupPluginBabelHelpers.createClass(ModalFooter, [{
...
function (_React$Component2) {
  _rollupPluginBabelHelpers.inherits(Modal, _React$Component2);
  ...
  function Modal(props) {
    ...
    _this2 = _rollupPluginBabelHelpers.possibleConstructorReturn(this, _rollupPluginBabelHelpers.getPrototypeOf(Modal).call(this, props));
    _this2.state = {
      hasStickyFooter: false,
      stickyFooterContainerRef: React__default.createRef()
    };
  ...
  _rollupPluginBabelHelpers.createClass(Modal, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(ModalAnimatedWrapper, {
        onCloseClick: onCloseClick,
...
exports.ModalAnimatedWrapper = ModalAnimatedWrapper;
exports.ModalContent = ModalContent;
exports.ModalContentFullBleed = ModalContentFullBleed;
