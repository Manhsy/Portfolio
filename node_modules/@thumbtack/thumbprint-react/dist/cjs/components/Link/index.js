...
var plain = require('../UIAction/plain.js');
...
var Link = React__default.forwardRef(function (_ref, ref) {
  ...
  return React__default.createElement(plain.default, _rollupPluginBabelHelpers.extends({}, getCommonLinkProps({
    to: to,
    onClick: onClick,
    target: target,
 ...
 */
var ThemedLink = React__default.forwardRef(function (_ref2, ref) {
  var to = _ref2.to,
  ...
  return React__default.createElement(themed.default, _rollupPluginBabelHelpers.extends({}, getCommonLinkProps({
    to: to,
    onClick: onClick,
    shouldOpenInNewTab: shouldOpenInNewTab,
    target: target,
