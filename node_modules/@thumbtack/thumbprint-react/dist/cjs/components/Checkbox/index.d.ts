...
export default function Checkbox({ checkboxVerticalAlign, children, dataTest, dataTestId, hasError, id, isChecked, isDisabled, isIndeterminate, labelPadding, isRequired, name, onChange, value, }: PropTypes): JSX.Element;
export {};
