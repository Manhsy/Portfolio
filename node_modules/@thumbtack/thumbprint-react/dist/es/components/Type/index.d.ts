...
export declare function Title({ children, size, className, headingLevel, dataTest, dataTestId, id, }: TitlePropTypes): JSX.Element;
...
export declare function Text({ children, size, className, elementName, dataTest, dataTestId, }: TextPropTypes): JSX.Element;
export {};
