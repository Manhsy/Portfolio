...
declare const TextArea: ({ dataTest, hasError, id, isDisabled, isReadOnly, isRequired, maxLength, onBlur, onChange, onFocus, placeholder, value, name, }: PropTypes) => JSX.Element;
