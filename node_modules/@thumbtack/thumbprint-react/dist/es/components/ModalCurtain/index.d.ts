...
interface PropTypes {
     ...
     */
    children?: ({ curtainClassName, curtainOnClick, }: {
...
export default function ModalCurtain({ stage, shouldCloseOnEscape, accessibilityLabel, initialFocus: initialFocusProp, onCloseClick, children, }: PropTypes): JSX.Element;
export {};
